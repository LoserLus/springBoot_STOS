...
CREATE TABLE `dglist`  (
  ...
  `DGDate` datetime NULL DEFAULT NULL COMMENT '日期',
  `DGALLnumber` int(11) NULL DEFAULT NULL COMMENT '购书总数',
  `DGALLprice` int(11) NULL DEFAULT NULL COMMENT '总额',
  ...
  CONSTRAINT `DSZname_user` FOREIGN KEY (`DGZname`) REFERENCES `nmuser` (`DGZname`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `DSZnumber_user` FOREIGN KEY (`DGZnumber`) REFERENCES `nmuser` (`DGZnumber`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  CONSTRAINT `Tel_user` FOREIGN KEY (`Tel`) REFERENCES `nmuser` (`NMtel`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `jslist`  (
  ...
  `CGdate` datetime NULL DEFAULT NULL COMMENT '采购日期',
  `CGnumber` int(11) NULL DEFAULT NULL COMMENT '采购数量',
  `CGprice` int(11) NULL DEFAULT NULL COMMENT '采购总额',
...
CREATE TABLE `lslist`  (
  ...
  `LSdate` datetime NULL DEFAULT NULL COMMENT '领书日期',
  `DGnumber` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '购书单号',
  `DGdate` datetime NULL DEFAULT NULL COMMENT '购书日期',
...
-- ----------------------------
-- Table structure for nmuser
-- ----------------------------
DROP TABLE IF EXISTS `nmuser`;
CREATE TABLE `nmuser`  (
  ...
  `NMtel` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系方式',
  `NMUser` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '账号',
  `NMPassword` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '密码',
  PRIMARY KEY (`DGZnumber`) USING BTREE,
  INDEX `name`(`DGZname`) USING BTREE,
  INDEX `tel`(`NMtel`) USING BTREE
...
-- Records of nmuser
-- ----------------------------
INSERT INTO `nmuser` VALUES ('DGZ001', '张三', '计科', '16359632563', 'za123', '123456');
INSERT INTO `nmuser` VALUES ('DGZ002', '李四', '马原', '13356322356', 'li123', '123456');
...
CREATE TABLE `qslist`  (
  ...
  `ISBN` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '书号',
  `QSALLnumber` int(11) NULL DEFAULT NULL COMMENT '数量',
